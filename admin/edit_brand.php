    ...
    <div class="offset-md-2 col-md-8">
        <form action="" method="post">
            <div class="form-group row">
                <h2 class="offset-lg-3 offset-md-2 offset-1 "> Update a Clothing brand </h2>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="brand_title">Brand</label>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" id="brand_title" name="brand_title" placeholder="Enter a Clothing Brand"
